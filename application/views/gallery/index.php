        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url($controller.'/addgallery'); ?>" class="btn btn-primary pull-right">Add</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?php if(!empty($allgallery)) { ?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="checkboxes">
                <?php $i=1; foreach($allgallery as $row) { 
                  if($row['status']) {
                  ...
                  if(file_exists(UPLOAD_GALLERY_PATH.$row['image'])) {
                      $img = SHOW_GALLERY_PATH.$row['image'];
                  } else {
                ...
                <tr>
                  ...
                  <td>
                    <a data-toggle="tooltip" class="btn btn-warning" title="Edit" href="<?php echo BASE_URL.'/gallery/edit/'.$row['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"  ></i>
                      </a>
                    <a onclick="return deleteconfirm();" class="btn btn-danger" title="Delete" href="<?php echo BASE_URL.'/gallery/delete/'.$row['id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                  </td>
                </tr>
                <?php $i++; } ?>                
                </tbody>
