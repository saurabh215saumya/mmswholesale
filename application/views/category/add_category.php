...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/add_newcategory'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
					...
					<input class="form-control" id="category_name" name="category_name" placeholder="Category Name" type="text" value="<?php echo set_value('category_name') ?>">
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" id="category_slug" name="category_slug" placeholder="Category Slug" type="text" value="<?php echo set_value('category_slug') ?>" required>
