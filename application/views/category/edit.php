...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/update_category'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
				<label for="name">Category Name<span style="color: #ff0000">*</span></label>
				<input class="form-control" name="category_name" id="category_name" placeholder="Category Name" type="text" value="<?php echo $details['category_name']; ?>" required>
			    ...
			    <div class="form-group">
					<label for="name">Category Slug : <span style="color: #ff0000">*</span></label>
					<?php echo BASE_URL; ?> <input class="form-control" name="category_slug" id="category_slug" placeholder="Category Slug<?php echo BASE_URL; ?> " type="text" value="<?php echo $details['category_slug']; ?>" readonly>
				  ...
				  <label class="control-label">Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/categories/'.$details['image'].'" width="25%"/></div>';
						} ?>
					</div>
				  ...
				  <label class="control-label">Banner Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['banner_image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/categories/'.$details['banner_image'].'" width="25%"/></div>';
						} ?>
					</div>
