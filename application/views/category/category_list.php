            ...
            <ul class="products-grid columns4">
                ...
                <div class="product">
                  <figure class="product-image-area">
                    <a href="demo-shop-5-product-details.html" title="Product Name"
                      ...
                      <img src="img/demos/shop/products/product5-2.jpg" alt="Product Name"
                        class="product-hover-image">
                    </a>
                  ...
                  <div class="product-details-area">
                    <h2 class="product-name"><a href="demo-shop-5-product-details.html"
                        title="Product Name">Fashion Jacket</a></h2>
                    <div class="product-ratings">
                      <div class="ratings-box">
                ...
                <div class="product">
                  <figure class="product-image-area">
                    <a href="demo-shop-5-product-details.html" title="Product Name"
                      ...
                      <img src="img/demos/shop/products/product6-2.jpg" alt="Product Name"
                        class="product-hover-image">
                    </a>
                  ...
                  <div class="product-details-area">
                    <h2 class="product-name"><a href="demo-shop-5-product-details.html"
                        title="Product Name">Blue Denim Jeans</a></h2>
                    <div class="product-ratings">
                      <div class="ratings-box">
              ...
              <li>
                <div class="product">
                  ...
                  <div class="product-details-area">
                    <h2 class="product-name"><a href="demo-shop-5-product-details.html"
                        title="Product Name">Black top</a></h2>
                    <div class="product-ratings">
                      <div class="ratings-box">
                        <div class="rating" style="width:0%"></div>
                      </div>
              ...
              <li>
                <div class="product">
                  ...
                  <div class="product-details-area">
                    <h2 class="product-name"><a href="demo-shop-5-product-details.html"
                        title="Product Name">Pink Fashion Dress</a></h2>
                    <div class="product-ratings">
                      <div class="ratings-box">
                        <div class="rating" style="width:60%"></div>
                      </div>
                ...
                <div class="product">
                  <figure class="product-image-area">
                    <a href="demo-shop-5-product-details.html" title="Product Name"
                      ...
                      <img src="img/demos/shop/products/product10-2.jpg" alt="Product Name"
                        class="product-hover-image">
                    </a>
                  ...
                  <div class="product-details-area">
                    <h2 class="product-name"><a href="demo-shop-5-product-details.html"
                        title="Product Name">Woman Fashion Dress</a></h2>
                    <div class="product-ratings">
                      <div class="ratings-box">
                ...
                <div class="product">
                  <figure class="product-image-area">
                    <a href="demo-shop-5-product-details.html" title="Product Name"
                      ...
                      <img src="img/demos/shop/products/product12-2.jpg" alt="Product Name"
                        class="product-hover-image">
                    </a>
                  ...
                  <div class="product-details-area">
                    <h2 class="product-name"><a href="demo-shop-5-product-details.html"
                        title="Product Name">Fashion Sweater - Pink</a></h2>
                    <div class="product-ratings">
                      <div class="ratings-box">
                        <div class="rating" style="width:60%"></div>
                      </div>
