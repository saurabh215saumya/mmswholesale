...
<div class="content-wrapper">
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active"><a href="<?php echo base_url($controller); ?>">Location</a></li>
	...
	<div class="row">
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<input class="form-control" name="location_name" id="location_name" placeholder="Location Name" type="text" value="<?php echo $details['location_name']; ?>" required>
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" name="location_slug" id="location_slug" placeholder="Location Slug<?php echo BASE_URL; ?> " type="text" value="<?php echo $details['location_slug']; ?>" readonly>
				  ...
				  <label class="control-label">Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/locations/'.$details['image'].'" width="25%"/></div>';
						} ?>
					</div>
				  ...
				  <label class="control-label">Banner Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['banner_image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/locations/'.$details['banner_image'].'" width="25%"/></div>';
						} ?>
					</div>
