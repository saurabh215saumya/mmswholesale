		...
		<div class="box">
			...
			<div class="box-body">
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" id="location_slug" name="location_slug" placeholder="Location Slug" type="text" value="<?php echo set_value('location_slug') ?>">
