  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo 'Testimonial'; ?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url($controller.'/addtestimonial'); ?>" class="btn btn-primary pull-right">Add</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?php if(!empty($alltestimonials)) { ?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="checkboxes">
                <?php $i=1; foreach($alltestimonials as $row) { 
                  ...
                  if(file_exists(UPLOAD_TESTIMONIAL_PATH.$row['image'])) {
                      $img = SHOW_TESTIMONIAL_PATH.$row['image'];
                  } else {
                    $img = SHOW_TESTIMONIAL_PATH.'noimage.png';
                  }
                ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  ...
                  <td>
                    <a data-toggle="tooltip" class="btn btn-warning" title="Edit" href="<?php echo BASE_URL.'/testimonial/edit/'.$row['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"  ></i>
                    </a>
                    <a onclick="return deleteconfirm();" class="btn btn-danger" title="Delete" href="<?php echo BASE_URL.'/testimonial/delete/'.$row['id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                  </td>
                </tr>
                <?php $i++; } ?>                
                </tbody>
