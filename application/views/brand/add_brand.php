...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/add_newbrand'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
					...
					<input class="form-control" id="brand_name" name="brand_name" placeholder="Brand Name" type="text" value="<?php echo set_value('brand_name') ?>">
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" id="brand_slug" name="brand_slug" placeholder="Brand Slug" type="text" value="<?php echo set_value('brand_slug') ?>">
