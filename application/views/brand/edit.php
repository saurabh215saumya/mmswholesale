...
<div class="content-wrapper">
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active"><a href="<?php echo base_url($controller); ?>">Brand</a></li>
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/update_brand'); ?>
			<div class="box-body">
			    <?php echo $this->session->flashdata('response'); ?>
			    <input type="hidden" name="brand_id" value="<?php echo $details['id']; ?>">
			    ...
			    <div class="form-group">
				<label for="name">Brand Name<span style="color: #ff0000">*</span></label>
				<input class="form-control" name="brand_name" id="brand_name" placeholder="Brand Name" type="text" value="<?php echo $details['brand_name']; ?>" required>
			    ...
			    <div class="form-group">
					<label for="name">Brand Slug : <span style="color: #ff0000">*</span></label>
					<?php echo BASE_URL; ?> <input class="form-control" name="brand_slug" id="brand_slug" placeholder="Brand Slug<?php echo BASE_URL; ?> " type="text" value="<?php echo $details['brand_slug']; ?>" readonly>
					<?php echo form_error('brand_slug'); ?>				
			    </div>
				  ...
				  <label class="control-label">Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/brands/'.$details['image'].'" width="25%"/></div>';
						} ?>
					</div>
				  ...
				  <label class="control-label">Banner Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['banner_image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/brands/'.$details['banner_image'].'" width="25%"/></div>';
						} ?>
					</div>
