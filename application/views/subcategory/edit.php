...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/update_subcategory'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
					...
					<input class="form-control" name="sub_category_name" id="sub_category_name" placeholder="Sub Category Name" type="text" value="<?php echo $details['sub_category_name']; ?>" required>
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" name="sub_category_slug" id="sub_category_slug" placeholder="Sub Category Slug<?php echo BASE_URL; ?> " type="text" value="<?php echo $details['sub_category_slug']; ?>" readonly>
