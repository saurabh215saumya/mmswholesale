        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url($controller.'/addsubcategory'); ?>" class="btn btn-primary pull-right">Add</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		<?php echo $this->session->flashdata('response'); ?>
            <?php if(!empty($allsubcategory)) { //echo '<pre>'; print_r($allinterest); die;?>		
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $i=1; foreach($allsubcategory as $row) { 
                ...
                <tr>
                  ...
                  <td>
                  <!-- <a data-toggle="tooltip" class="btn btn-success" title="Add Gallery Image" href="<?php echo BASE_URL.'/category/addgallery/'.$row['id'] ?>"><i class="fa fa-plus" aria-hidden="true"  ></i>
                  </a> -->

                  <a data-toggle="tooltip" class="btn btn-warning" title="Edit Service" href="<?php echo BASE_URL.'/subcategory/edit/'.$row['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"  ></i>
                  </a>

                  <!-- <a data-toggle="tooltip" class="btn btn-primary" title="View Gallery" href="<?php echo BASE_URL.'/category/gallerylist/'.$row['id'] ?>"><i class="glyphicon glyphicon-eye-open" aria-hidden="true"  ></i>
                  </a> -->

                  <a onclick="return deleteconfirm();"  data-toggle="tooltip" class="btn btn-danger" title="Delete Product" href="<?php echo BASE_URL.'/subcategory/delete/'.$row['id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i>
                  </a>                
                  </td>
                </tr>
                <?php $i++; } ?>                
