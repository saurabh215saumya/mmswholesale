<?php //echo '<pre>'; print_r($subCategoryDataArr); die; ?>
...
<div class="content-wrapper">
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active"><a href="<?php echo base_url($controller); ?>">Product</a></li>
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/update_product'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
					<label>Select Category<span style="color: #ff0000">*</span></label>
					<select class="form-control" id="category_id" name="category_id" onchange="return getSubCategory(this.value);" required>
					    <option value="">Select Category</option>
					    <?php if(!empty($categoryDataArr)){
					    	foreach($categoryDataArr as $categoryData){ ?>
					    		<option value="<?php echo $categoryData->id; ?>" <?php if($details['category_id'] == $categoryData->id){ echo "selected"; } ?>><?php echo $categoryData->category_name; ?></option>
					    <?php } } ?>
					</select>
			    ...
			    <div class="form-group">
					...
					<select class="form-control" id="sub_category_id" name="sub_category_id" required>
					    ...
					    <?php if(!empty($subCategoryDataArr)){
					    	foreach($subCategoryDataArr as $subCategoryData){ ?>
					    		<option value="<?php echo $subCategoryData->id; ?>" <?php if($details['sub_cat_id'] == $subCategoryData->id){ echo "selected"; } ?>><?php echo $subCategoryData->sub_category_name; ?></option>
					    <?php } } ?>
					</select>
			    ...
			    <div class="form-group">
					...
					<input class="form-control" name="product_name" id="product_name" placeholder="Product Name" type="text" value="<?php echo $details['product_name']; ?>" required>
					<?php echo form_error('product_name'); ?>				
			    </div>

			    <div class="form-group">
					<label for="name">Product Code<span style="color: #ff0000">*</span></label>
					<input class="form-control" name="product_code" id="product_code" placeholder="Product Code" type="text" value="<?php echo $details['product_code']; ?>">
					<?php echo form_error('product_code'); ?>				
			    </div>

			    <div class="form-group">
					<label for="name">Quantity<span style="color: #ff0000">*</span></label>
					<input class="form-control" name="quantity" id="quantity" placeholder="Quantity" type="text" value="<?php echo $details['quantity']; ?>">
					<?php echo form_error('quantity'); ?>				
			    </div>

			    <div class="form-group">
					<label for="name">Wholesaler Price<span style="color: #ff0000"></span></label>
					<input class="form-control" name="wholesale_price" id="wholesale_price" placeholder="Wholesaler Price" type="text" value="<?php echo $details['wholesale_price']; ?>">
					<?php echo form_error('wholesale_price'); ?>				
			    </div>

			    <div class="form-group">
					<label for="name">Retailer Price<span style="color: #ff0000">*</span></label>
					<input class="form-control" name="retailer_price" id="retailer_price" placeholder="Retailer Price" type="text" value="<?php echo $details['retailer_price']; ?>" required>
					<?php echo form_error('retailer_price'); ?>				
			    </div>

			    <div class="form-group">
					<label for="name">Traider Price<span style="color: #ff0000"></span></label>
					<input class="form-control" name="price" id="price" placeholder="Traider Price" type="text" value="<?php echo $details['price']; ?>">
			    ...
			    <div class="form-group">
					<label for="name">Product Slug : <span style="color: #ff0000">*</span></label>
					<?php echo BASE_URL; ?> <input class="form-control" name="product_slug" id="product_slug" placeholder="Product Slug<?php echo BASE_URL; ?> " type="text" value="<?php echo $details['product_slug']; ?>" readonly>
				  ...
				  <label class="control-label">Image:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/products/'.$details['image'].'" width="25%"/></div>';
						} ?>
					</div>
				...
				<div class="control-group">
				  <label class="control-label">Product Image_1:</label>
					<div class="controls">
						<input type="file" class="span11" name="image_file_1" id="image_file_1"/>
						<input type="hidden" name="image_file_name" id="image_file_name" value="<?php echo $details['image_1'];?>"/>
						<?php if(!empty($details['image_1'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/products/'.$details['image_1'].'" width="25%"/></div>';
						} ?>
					</div>
				...
				<div class="control-group">
				  <label class="control-label">Product Image_2:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image_2'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/products/'.$details['image_2'].'" width="25%"/></div>';
						} ?>
					</div>
					<!-- <div style="color: red">*Upload Image size should be 1020(Height)*1000(Width).</div> -->
				</div>
				...
				<div class="control-group">
				  <label class="control-label">Product Image_3:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image_3'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/products/'.$details['image_3'].'" width="25%"/></div>';
						} ?>
					</div>
					<!-- <div style="color: red">*Upload Image size should be 1020(Height)*1000(Width).</div> -->
				</div>
				...
				<div class="control-group">
				  <label class="control-label">Product Image_4:</label>
					<div class="controls">
						...
						<?php if(!empty($details['image_4'])) {
							echo '<div><img src="'.BASE_URL.'/uploads/products/'.$details['image_4'].'" width="25%"/></div>';
						} ?>
					</div>
					<!-- <div style="color: red">*Upload Image size should be 1020(Height)*1000(Width).</div> -->
				</div>
				...
				<textarea class="form-control" name="meta_description" id="meta_description" placeholder="Meta Description" cols="109"><?php echo $details['meta_description']; ?></textarea>			
			    </div>

			    <div class="form-group">
				<label for="name">Meta Keywords<span style="color: #ff0000"></span></label>
				<textarea class="form-control" name="meta_keywords" id="meta_keywords" placeholder="Meta Keywords" cols="109"><?php echo $details['meta_keywords']; ?></textarea>			
			    </div>
...
<script type="text/javascript">
	function getSubCategory(id){ //alert(id); return false;
		var saveData = $.ajax({
	        type: "POST",
	        url: "<?php echo base_url('subcategory/getAllSubCategory'); ?>",
	        data:"category_id="+id,
	        dataType: "text",
	        success: function(resultData){ //alert(resultData); return false;
	            document.getElementById("sub_category_id").innerHTML = resultData;
	        }       
	    });
	}
</script>