...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="box">
		    ...
		    <div class="box-body">
			<!-- form start -->
			<?php echo form_open_multipart($controller.'/add_newproduct'); ?>
			<div class="box-body">
			    ...
			    <div class="form-group">
					...
					<input class="form-control" id="product_name" name="product_name" placeholder="Product Name" type="text" value="<?php echo set_value('product_name') ?>" required>
					<?php echo form_error('product_name'); ?>
			    </div>

			    <div class="form-group">
					<label for="name">Product Code<span style="color: #ff0000">*</span></label>
					<input class="form-control" id="product_code" name="product_code" placeholder="Product Code" type="text" value="<?php echo set_value('product_code') ?>" required>
					<?php echo form_error('product_code'); ?>
			    </div>

			    <div class="form-group">
					<label for="name">Quantity<span style="color: #ff0000">*</span></label>
					<input class="form-control" id="quantity" name="quantity" placeholder="Quantity" type="text" value="<?php echo set_value('quantity') ?>" required>
					<?php echo form_error('quantity'); ?>
			    </div>

			    <div class="form-group">
					<label for="name">Wholesaler Price<span style="color: #ff0000"></span></label>
					<input class="form-control" id="wholesale_price" name="wholesale_price" placeholder="Wholesaler Price" type="text" value="<?php echo set_value('wholesale_price') ?>">
					<?php echo form_error('wholesale_price'); ?>
			    </div>

			    <div class="form-group">
					<label for="name">Retailer Price<span style="color: #ff0000">*</span></label>
					<input class="form-control" id="retailer_price" name="retailer_price" placeholder="Retailer Price" type="text" value="<?php echo set_value('retailer_price') ?>" required>
					<?php echo form_error('retailer_price'); ?>
			    </div>

			    <div class="form-group">
					<label for="name">Traider Price<span style="color: #ff0000">*</span></label>
					<input class="form-control" id="price" name="price" placeholder="Traider Price" type="text" value="<?php echo set_value('price') ?>" required>
			    ...
			    <div class="form-group">
					...
					<?php echo BASE_URL; ?> <input class="form-control" id="product_slug" name="product_slug" placeholder="Product Slug" type="text" value="<?php echo set_value('product_slug') ?>" required>
			    ...
			    <div class="control-group">
				  <label class="control-label">Product Image_1:</label>
					<div class="controls">
						<input type="file" class="span11" name="image_file_1" id="uploadedImage" required />
					</div>
