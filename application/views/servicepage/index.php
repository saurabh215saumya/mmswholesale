        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url($controller.'/addservicepage'); ?>" class="btn btn-primary pull-right">Add</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?php if(!empty($allservicepages)) { ?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="checkboxes">
                <?php $i=1; foreach($allservicepages as $row) { 
                  ...
                  if(file_exists(UPLOAD_SERVICE_PATH.$row['banner_image'])) {
                      $img = SHOW_SERVICE_PATH.$row['banner_image'];
                  } else {
                    $img = SHOW_SERVICE_PATH.'noimage.png';
                  }
                ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $row['service_page_name']; ?></td>
                  <td><?php echo $row['service_slug']; ?></td>
                  ...
                  <td>
                    <a data-toggle="tooltip" class="btn btn-warning" title="Edit" href="<?php echo BASE_URL.'/servicepage/edit/'.$row['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"  ></i>
                    </a>
                    <a onclick="return deleteconfirm();" class="btn btn-danger" title="Delete" href="<?php echo BASE_URL.'/servicepage/delete/'.$row['id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                  </td>
                </tr>
                <?php $i++; } ?>                
                </tbody>
